...
export default function Reviewpage(){
    ...
    if(isLoading){
        return <div>Laoding reviews...</div>
    }
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            <div className="text-center py-12">
                                <p className="text-muted-foreground">No reviews yet. Connect a repository and create a pull request</p>
                            </div>
                        </CardContent>
                    </Card>
                ):(
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <Button variant="outline" asChild>
                                            <a href={review.prUrl} target="_blank" rel="noopener noreferance">
